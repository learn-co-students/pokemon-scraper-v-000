...
describe "Pokemon" do
  ...
  pending describe "BONUS" do
    ...
    pending it "knows that a pokemon have a default hp of 60" do
    ...
    pending it "alters Pikachu's hp to 59" do
      pending "Implement the bonus section of the README. Then remove this line."
    ...
    pending it "alters Magikarp's hp" do
      pending "Implement the bonus section of the README. Then remove this line."
